...
class GimpBackend(Protocol):
    ...
    def select_rect(self, image_id: str, x: int, y: int, width: int, height: int) -> dict[str, Any]: ...
    def fill_selection(self, image_id: str, color: str = "#000000") -> dict[str, Any]: ...
    def stroke_selection(self, image_id: str, color: str = "#ffffff", stroke_width: int = 2) -> dict[str, Any]: ...
